...
export const CallUsIcon = ({ width = "1.2rem", height = "1.2rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const UserIcon = ({ width = "1rem", height = "1rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const EnvelopeIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const LockIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const ArrowHorizonIcon = ({ width = "1.2rem", height = "1.2rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const GiftIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const TickBagIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        ...
        <path
            ...
            strokeLinejoin="round"
            strokeWidth="32"
            d="M320 264l-89.6 112-38.4-44.88"></path>
        <path
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export const QuestionIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const GroupIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="0"
...
export const InCallIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="0"
...
export const ShieldIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="0"
...
export const FileIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="0"
...
export const ExclamationIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="2"
...
export const BagIcon = ({ width = "2.4rem", height = "2.4rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const BagGreenIcon = ({ width = "3.6rem", height = "3.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const BagGreyIcon = ({ width = "3.6rem", height = "3.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const TrashIcon = ({ width = "1.8rem", height = "1.8rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const XMarkIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const CartPlusIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const HeartPlusIcon = ({ width = "1.9rem", height = "1.9rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        ...
        viewBox="0 0 512 512"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M372.48 31.215c-77.65 0-116.48 65.73-116.48 65.73s-38.83-65.72-116.48-65.72c-37.14 0-107.77 33.72-107.77 125.13 0 161.24 224.25 324.43 224.25 324.43s224.25-163.19 224.25-324.43c0-91.42-70.63-125.13-107.77-125.14zm-145.492 115.02h60.698v79.415h79.238v60.7h-79.238v79.884h-60.698V286.35h-80.064v-60.7h80.064z" />
    </svg>
)

export const DashBoardIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const MenuBarIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const OptionIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const UnlockIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        ...
        <path
            ...
            strokeLinejoin="round"
            strokeWidth="32"
            d="M336 112a80 80 0 00-160 0v96"></path>
        <rect
            width="320"
            height="272"
            x="96"
...
export const FreeShipIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const PaymentIcon = ({ width = "1.6rem", height = "1.6rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const CircleFBIcon = ({ width = "3.3rem", height = "3.3rem", className }) => (
...
export const TweeterIcon = ({ width = "3.3rem", height = "3.3rem", className }) => (
    <svg viewBox="0 0 64 64" width={width} height={height} className={className}>
...
export const PinterestIcon = ({ width = "3.3rem", height = "3.3rem", className }) => (
    <svg viewBox="0 0 64 64" width={width} height={height} className={className}>
...
export const LinkedinIcon = ({ width = "3.3rem", height = "3.3rem", className }) => (
    <svg viewBox="0 0 64 64" width={width} height={height} className={className}>
...
export const WhatsappIcon = ({ width = "3.3rem", height = "3.3rem", className }) => (
    <svg viewBox="0 0 64 64" width={width} height={height} className={className}>
...
export const UploadCloudIcon = ({ width = "3rem", height = "3rem", className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
